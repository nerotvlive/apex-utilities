...
public class NexusResizer extends MouseAdapter {
     ...
     *            Insets specifying which borders are eligible to be resized.
     * @param snapSize
     *            Specify the dimension to which the border will snap to when being dragged.
     ...
     *
     * @param snapSize
     *            Dimension object allows you to separately spcify a horizontal and vertical snap
     *            size.
     */
